...
function showInfo(data) {
    if (data) {
        ...
        $('#info_position').text(data.place);
        $('#info_author').text(data.author);
        $('#info_code').text(data.code);
        if (data.code != "---") {
            $('#info_code').attr('href', data.code);
        } else {
            $('#info_code').attr('href', '#');
        }
        $('#info_url').text(data.url);
        $('#info_url').attr('href', data.url);
    ...
    */
    ...
    $.ajax({
        ...
        success: function (data) {
            elenco = data
            var scheda = elenco.filter(element => element.id == 5);
            showInfo(scheda[0])
        },
